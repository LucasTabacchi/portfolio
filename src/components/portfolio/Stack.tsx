...
/**
 * Custom Mercado Pago icon — the original SiMercadopago from react-icons
 * renders blurry at small sizes. This uses the official Simple Icons path
 * with geometricPrecision rendering for crispness.
 */
const MercadoPagoIcon: IconType = ({ className, style, ...props }) => (
  <svg
    viewBox="0 0 24 24"
    fill="currentColor"
    className={className}
...
const groups: {
  ...
  },
  {
    ...
    dot: "bg-violet",
    items: [
      { name: "Mercado Pago", Icon: MercadoPagoIcon, color: "#00B1EA" },
