...
const Hero = () => {
  ...
  return (
    <section
      id="top"
      className="relative min-h-[100dvh] flex items-start lg:items-center overflow-hidden"
    >
      ...
      <div className="container relative pt-28 lg:pt-32 pb-20">
        <div className="grid lg:grid-cols-[1.4fr_1fr] gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4 animate-fade-up" style={{ animationDelay: "0.3s" }}>
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-7 py-4 rounded-full border border-foreground/20 bg-background/40 backdrop-blur-sm hover:border-primary hover:text-primary hover:bg-primary/5 hover:scale-[1.04] transition-all duration-300"
            >
              Contactarme
            </a>
            ...
            <div className="flex items-center gap-2 ml-2">
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  className="size-11 grid place-items-center rounded-full border border-foreground/20 bg-background/40 backdrop-blur-sm hover:border-primary hover:bg-primary/5 hover:text-primary hover:scale-110 hover:shadow-[0_0_20px_hsl(var(--primary)/0.5)] transition-all duration-300"
                >
